...
SECRET_KEY = 'django-insecure-xxjf5t68v46^a4hm5nr_mgl74)17j$k+2qkr0yz78$-l1+29sh'
...
INSTALLED_APPS = [
    ...
    'job.apps.JobConfig',  # Correct class name
...
TEMPLATES = [
    ...
    'context_processors': [
        ...
        'job.context_processors.notifications',
        'job.context_processors.notification_count',
    ],
},
    },
]
